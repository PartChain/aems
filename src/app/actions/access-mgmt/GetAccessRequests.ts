...
/**
 * List all mspIDs which requested access to your private data collection
 * @param req
 * @param res
 * @param next
 * @constructor
 */
export default async function GetAccessRequests(req: any, res: any, next: any) {
 ...
 * @ignore
 * @swagger
 * /v1/access-mgmt/get-access-requests:
 *   get:
 *     security:
 *       - Bearer: []
 *     description: List all mspIDs which requested access to your private data collection
 *     tags: ['access-mgmt']
 *     produces:
 *       - application/json
 *     responses:
